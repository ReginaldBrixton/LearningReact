...
const Header = ({ isDarkMode, toggleTheme }) => {
  ...
  return (
    <header className={`${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'} border-b border-gray-200 dark:border-gray-800 py-2 px-4 transition-colors duration-300`}>
